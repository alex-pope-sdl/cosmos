...
module OpenC3
  describe XtceConverter do
    ...
    def sample_simple_tlm_packet_with_alias(tf, with_allow_short: false)
      ...
      tf.puts "      <xtce:IntegerParameterType name=\"TLM__OPCODE_Type\" shortDescription=\"TLM_OPCODE Description\" signed=\"false\">"
      ...
      tf.puts "      <xtce:Parameter name=\"TLM__OPCODE\" parameterTypeRef=\"TLM__OPCODE_Type\">"
      ...
      tf.puts "          <xtce:ParameterRefEntry parameterRef=\"TLM__OPCODE\"/>"
      tf.puts "        </xtce:EntryList>"
      tf.puts "        <xtce:BaseContainer containerRef=\"TLMPKT\">"
      tf.puts "          <xtce:RestrictionCriteria>"
      tf.puts "            <xtce:ComparisonList>"
      tf.puts "              <xtce:Comparison parameterRef=\"TLM__OPCODE\" value=\"0\"/>"
      tf.puts "            </xtce:ComparisonList>"
      tf.puts "          </xtce:RestrictionCriteria>"
    ...
    def sample_simple_cmd_packet_with_alias(tf)
      tf.puts "    <xtce:ParameterTypeSet>"
      tf.puts "      <xtce:IntegerParameterType name=\"CMD_CMD__0____ATTRIBUTES__ID_Type\" initialValue=\"0\" shortDescription=\"CMD_ID Description\" signed=\"false\">"
      tf.puts "        <xtce:UnitSet/>"
      ...
      tf.puts "    </xtce:ParameterTypeSet>"
      tf.puts "    <xtce:ParameterSet>"
      tf.puts "      <xtce:Parameter name=\"CMD_CMD__0____ATTRIBUTES__ID\" parameterTypeRef=\"CMD_CMD__0____ATTRIBUTES__ID_Type\">"
      tf.puts "        <xtce:AliasSet>"
      ...
      tf.puts "      <xtce:EnumeratedArgumentType name=\"CMDPKT_CMD__0____ATTRIBUTES__BOOL_Type\" initialValue=\"TRUE\" shortDescription=\"Unsigned\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:IntegerDataEncoding sizeInBits=\"16\" encoding=\"unsigned\" byteOrder=\"leastSignificantByteFirst\"/>"
      ...
      tf.puts "          <xtce:Argument name=\"CMD__0____ATTRIBUTES__BOOL\" argumentTypeRef=\"CMDPKT_CMD__0____ATTRIBUTES__BOOL_Type\" initialValue=\"TRUE\">"
      tf.puts "            <xtce:AliasSet>"
      ...
      tf.puts "          <xtce:EntryList>"
      tf.puts "            <xtce:ParameterRefEntry parameterRef=\"CMD_CMD__0____ATTRIBUTES__ID\"/>"
      tf.puts "            <xtce:ArgumentRefEntry argumentRef=\"CMD__0____ATTRIBUTES__BOOL\"/>"
      tf.puts "          </xtce:EntryList>"
      tf.puts "          <xtce:BaseContainer containerRef=\"CMDPKT_Commands\">"
      tf.puts "            <xtce:RestrictionCriteria>"
      tf.puts "              <xtce:ComparisonList>"
      tf.puts "                <xtce:Comparison parameterRef=\"CMD_CMD__0____ATTRIBUTES__ID\" value=\"0\"/>"
      tf.puts "              </xtce:ComparisonList>"
      tf.puts "            </xtce:RestrictionCriteria>"
      tf.puts "          </xtce:BaseContainer>"
    ...
    def basic_types
      ...
      tf.puts "      </xtce:IntegerParameterType>"
      tf.puts "      <xtce:IntegerParameterType name=\"ARRAY__ITEM_Type\" shortDescription=\"Array\" signed=\"false\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:IntegerDataEncoding sizeInBits=\"8\" encoding=\"unsigned\"/>"
      tf.puts "      </xtce:IntegerParameterType>"
      tf.puts "      <xtce:ArrayParameterType name=\"ARRAY__ITEM_ArrayType\" shortDescription=\"Array\" arrayTypeRef=\"ARRAY__ITEM_Type\">"
      ...
      tf.puts "      <xtce:Parameter name=\"ARRAY__ITEM\" parameterTypeRef=\"ARRAY__ITEM_ArrayType\">"
      tf.puts "        <xtce:AliasSet>"
      ...
      tf.puts "    </xtce:ParameterSet>"
      tf.puts "    <xtce:ContainerSet>"
      tf.puts "      <xtce:SequenceContainer name=\"TLM__PKT\" shortDescription=\"Telemetry\">"
      tf.puts "        <xtce:AliasSet>"
      ...
      tf.puts "            </xtce:LocationInContainerInBits>"
      tf.puts "          </xtce:ParameterRefEntry>"
      tf.puts "          <xtce:ArrayParameterRefEntry parameterRef=\"ARRAY__ITEM\">"
      tf.puts "            <xtce:LocationInContainerInBits referenceLocation=\"containerStart\">"
      ...
      tf.puts "          </xtce:ParameterRefEntry>"
      tf.puts "        </xtce:EntryList>"
      tf.puts "        <xtce:BaseContainer containerRef=\"TLM__PKT\">"
      tf.puts "          <xtce:RestrictionCriteria>"
      tf.puts "            <xtce:ComparisonList>"
      ...
      tf.puts "    </xtce:ParameterSet>"
      tf.puts "    <xtce:ArgumentTypeSet>"
      tf.puts "      <xtce:EnumeratedArgumentType name=\"CMD__PKT_CMD_UNSIGNED_Type\" initialValue=\"TRUE\" shortDescription=\"Unsigned\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:IntegerDataEncoding sizeInBits=\"16\" encoding=\"unsigned\" byteOrder=\"leastSignificantByteFirst\"/>"
      tf.puts "        <xtce:EnumerationList>"
      tf.puts "          <xtce:Enumeration value=\"0\" label=\"FALSE\"/>"
      ...
      tf.puts "        </xtce:EnumerationList>"
      tf.puts "      </xtce:EnumeratedArgumentType>"
      tf.puts "      <xtce:IntegerArgumentType name=\"CMD__PKT_CMD_SIGNED_Type\" initialValue=\"0\" shortDescription=\"Signed\" signed=\"true\">"
      tf.puts "        <xtce:UnitSet>"
      tf.puts "          <xtce:Unit description=\"Kilos\">K</xtce:Unit>"
      tf.puts "        </xtce:UnitSet>"
      ...
      tf.puts "      <xtce:FloatArgumentType name=\"CMD__PKT_CMD_ARRAY_Type\" sizeInBits=\"64\" shortDescription=\"Array of 10 64bit floats\">"
      tf.puts "        <xtce:UnitSet/>"
      ...
      tf.puts "      <xtce:ArrayArgumentType name=\"CMD__PKT_CMD_ARRAY_ArrayType\" shortDescription=\"Array of 10 64bit floats\" arrayTypeRef=\"CMD__PKT_CMD_ARRAY_Type\">"
      tf.puts "        <xtce:DimensionList>"
      tf.puts "          <xtce:Dimension>"
      tf.puts "            <xtce:StartingIndex>"
      tf.puts "              <xtce:FixedValue>0</xtce:FixedValue>"
      ...
      tf.puts "      <xtce:FloatArgumentType name=\"CMD__PKT_CMD_FLOAT_Type\" sizeInBits=\"32\" initialValue=\"10.0\" shortDescription=\"Float\">"
      tf.puts "        <xtce:UnitSet/>"
      ...
      tf.puts "        </xtce:FloatDataEncoding>"
      tf.puts "      </xtce:FloatArgumentType>"
      tf.puts "      <xtce:FloatArgumentType name=\"CMD__PKT_CMD_DOUBLE_Type\" sizeInBits=\"64\" initialValue=\"0.0\" shortDescription=\"Double\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:FloatDataEncoding sizeInBits=\"64\" encoding=\"IEEE754_1985\" byteOrder=\"leastSignificantByteFirst\"/>"
      tf.puts "      </xtce:FloatArgumentType>"
      tf.puts "      <xtce:StringArgumentType name=\"CMD__PKT_CMD_STRING_Type\" characterWidth=\"8\" initialValue=\"&quot;DEAD&quot;\" shortDescription=\"String\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:StringDataEncoding encoding=\"UTF-8\">"
      tf.puts "          <xtce:SizeInBits>"
      tf.puts "            <xtce:Fixed>"
      ...
      tf.puts "      <xtce:StringArgumentType name=\"CMD__PKT_CMD_STRING2_Type\" characterWidth=\"8\" initialValue=\"0xDEAD\" shortDescription=\"Binary\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:StringDataEncoding encoding=\"UTF-8\">"
      tf.puts "          <xtce:SizeInBits>"
      tf.puts "            <xtce:Fixed>"
      ...
      tf.puts "        </xtce:StringDataEncoding>"
      tf.puts "      </xtce:StringArgumentType>"
      tf.puts "      <xtce:BinaryArgumentType name=\"CMD__PKT_CMD_BLOCK_Type\" initialValue=\"0xBEEF\" shortDescription=\"Block\">"
      tf.puts "        <xtce:UnitSet/>"
      tf.puts "        <xtce:BinaryDataEncoding>"
      tf.puts "          <xtce:SizeInBits>"
      tf.puts "            <xtce:FixedValue>32</xtce:FixedValue>"
      ...
      tf.puts "    </xtce:ArgumentTypeSet>"
      tf.puts "    <xtce:MetaCommandSet>"
      tf.puts "      <xtce:MetaCommand name=\"CMD__PKT\" shortDescription=\"Command\">"
      tf.puts "        <xtce:AliasSet>"
      tf.puts "          <xtce:Alias nameSpace=\"COSMOS\" alias=\"CMD/PKT\"/>"
      tf.puts "        </xtce:AliasSet>"
      tf.puts "        <xtce:ArgumentList>"
      tf.puts "          <xtce:Argument name=\"CMD_UNSIGNED\" argumentTypeRef=\"CMD__PKT_CMD_UNSIGNED_Type\" initialValue=\"TRUE\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_SIGNED\" argumentTypeRef=\"CMD__PKT_CMD_SIGNED_Type\" initialValue=\"0\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_ARRAY\" argumentTypeRef=\"CMD__PKT_CMD_ARRAY_ArrayType\" initialValue=\"\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_FLOAT\" argumentTypeRef=\"CMD__PKT_CMD_FLOAT_Type\" initialValue=\"10.0\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_DOUBLE\" argumentTypeRef=\"CMD__PKT_CMD_DOUBLE_Type\" initialValue=\"0.0\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_STRING\" argumentTypeRef=\"CMD__PKT_CMD_STRING_Type\" initialValue=\"&quot;DEAD&quot;\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_STRING2\" argumentTypeRef=\"CMD__PKT_CMD_STRING2_Type\" initialValue=\"0xDEAD\"/>"
      tf.puts "          <xtce:Argument name=\"CMD_BLOCK\" argumentTypeRef=\"CMD__PKT_CMD_BLOCK_Type\" initialValue=\"0xBEEF\"/>"
      tf.puts "        </xtce:ArgumentList>"
      tf.puts "        <xtce:CommandContainer name=\"CMD__PKT_Commands\">"
      tf.puts "          <xtce:EntryList>"
      ...
      tf.puts "          </xtce:EntryList>"
      tf.puts "          <xtce:BaseContainer containerRef=\"CMD__PKT_Commands\">"
      tf.puts "            <xtce:RestrictionCriteria>"
      tf.puts "              <xtce:ComparisonList>"
    ...
    def algorithm_xtce
      ...
      tf.puts "    <xtce:ParameterTypeSet>"
      tf.puts "<!--TODO: "
      tf.puts "	<xtce:TODOParameterType name=\"ITEM1__DERIVED_Type\" shortDescription=\"DERIVED Item\" />"
      tf.puts "-->"
      tf.puts ""
      tf.puts "<!--TODO: "
      tf.puts "	<xtce:TODOParameterType name=\"ITEM2__DERIVED_Type\" shortDescription=\"DERIVED Item\" />"
      tf.puts "-->"
      ...
      tf.puts "    <xtce:ParameterSet>"
      tf.puts "<!-- TODO: "
      tf.puts "	<xtce:Parameter name=\"ITEM1__DERIVED\" parameterTypeRef=\"ITEM1__DERIVED_Type\">"
      tf.puts "\t\t<xtce:ParameterProperties dataSource=\"derived\"/>"
      tf.puts "		<xtce:AliasSet>"
      tf.puts "			<xtce:Alias nameSpace=\"COSMOS\" alias=\"ITEM1__DERIVED\"/>"
      tf.puts "		</xtce:AliasSet>"
      tf.puts "	</xtce:Parameter>"
      tf.puts "-->"
      tf.puts ""
      tf.puts "<!-- TODO: "
      tf.puts "	<xtce:Parameter name=\"ITEM2__DERIVED\" parameterTypeRef=\"ITEM2__DERIVED_Type\">"
      tf.puts "\t\t<xtce:ParameterProperties dataSource=\"derived\"/>"
      tf.puts "		<xtce:AliasSet>"
      tf.puts "			<xtce:Alias nameSpace=\"COSMOS\" alias=\"ITEM2__DERIVED\"/>"
      tf.puts "		</xtce:AliasSet>"
      tf.puts "	</xtce:Parameter>"
      tf.puts "-->"
      ...
      tf.puts "  <CustomAlgorithm name=\"PKT2_ITEM2__DERIVED_Conversion2\">"
      ...
      tf.puts "    </InputSet>"
      tf.puts "    <OutputSet>"
      tf.puts "      <OutputParameterRef parameterRef=\"ITEM2__DERIVED\"/>"
      tf.puts "    </OutputSet>"
      tf.puts "    <TriggerSet name=\"triggerSet\">"
      tf.puts "      <OnParameterUpdateTrigger parameterRef=\"TODO\"/>"
      tf.puts "    </TriggerSet>"
      tf.puts "  </CustomAlgorithm>"
      tf.puts "  <CustomAlgorithm name=\"PKT1_ITEM1__DERIVED_Conversion2\">"
      tf.puts "    <ExternalAlgorithmSet>"
      tf.puts "      <ExternalAlgorithm implementationName=\"TODO\" algorithmLocation=\"TODO\"/>"
      tf.puts "    </ExternalAlgorithmSet>"
      tf.puts "    <InputSet>"
      ...
      tf.puts "    </InputSet>"
      tf.puts "    <OutputSet>"
      tf.puts "      <OutputParameterRef parameterRef=\"ITEM1__DERIVED\"/>"
      tf.puts "    </OutputSet>"
      tf.puts "    <TriggerSet name=\"triggerSet\">"
      tf.puts "      <OnParameterUpdateTrigger parameterRef=\"TODO\"/>"
      tf.puts "    </TriggerSet>"
